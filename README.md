...
---
Use PhpMyAdmin, create a new "api_db" database. After that, run the following SQL queries to create new tables with sample data.
...
- Configure your databse and run this page
### Read More Information
[REST API] : Enhance your REST API skill. 




   [REST API]: https://www.codeofaninja.com/2017/02/create-simple-rest-api-in-php.html
